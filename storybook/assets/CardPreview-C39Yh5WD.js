...
`,h=i.div`
  width: 36px;
  height: 22px;
  background: ${({theme:e})=>e.colors.cardPreviewICColor};
  border: 0.5px solid ${({theme:e})=>e.colors.cardPreviewICBorder};
  border-radius: 4px;
`,M=i.img`
  width: 36px;
  height: 22px;
...
`,x=i.div`
  ...
  height: 4px;
  border-radius: 50%;
  background: ${({theme:e})=>e.colors.cardPreviewText};
`;function E({cardInformation:e}){const s=o(e.cardNumbers[0].value);return r.jsxs(v,{children:[r.jsxs(g,{children:[r.jsx(h,{}),s&&r.jsx(M,{src:s})]}),r.jsxs(R,{children:[r.jsxs(t,{children:[r.jsx(A,{children:e.cardNumbers[0].value}),r.jsx(A,{children:e.cardNumbers[1].value}),r.jsx(d,{children:Array.from({length:e.cardNumbers[2].value.length}).map((p,n)=>r.jsx(x,{},n))}),r.jsx(d,{children:Array.from({length:e.cardNumbers[3].value.length}).map((p,n)=>r.jsx(x,{},n))})]}),r.jsx(t,{children:r.jsxs("div",{children:[r.jsx(A,{children:e.cardExpirationMonth.value}),e.cardExpirationMonth.value.length===2&&"/",r.jsx(A,{children:e.cardExpirationYear.value})]})}),r.jsx(t,{children:r.jsx(A,{children:e.cardOwnerName.value})})]})]})}E.__docgenInfo={description:"",methods:[],displayName:"CardPreview",props:{cardInformation:{required:!0,tsType:{name:"CardInformation"},description:""}}};export{E as C,u as O,m as a};
